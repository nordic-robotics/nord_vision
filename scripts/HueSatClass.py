...
class HueSatClass:
    def __init__(self):
        ...
        with open(os.path.join(path, 'data/pixel_hue_sat/rbf_svm_g0_0001_C464158_lookuptable.pkl'), 'rb') as fid:
            self.classifier_lookup = cPickle.load(fid)
    ...
    def classify(self,features):
        ...
        votes = self.classifier_lookup[features[:,1],features[:,0]]
